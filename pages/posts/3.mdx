...
So if you want to use the new concurrent features React 18 brings (and you will), many of the most popular
css-in-js libraries will likely not work well.
...
So with a heavy heart I'm pouring one out for some of my favorite tools. Goodbye Emotion. Goodbye Stitches...so young (ಥ﹏ಥ).
